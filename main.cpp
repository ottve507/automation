...
int main(int argc, char **argv)
{
	...
	if (argc != 3)
	{
		printf("RC Socket Control Program. Written by Geoff Johnson.\n usage: switch 1-4 on/off\n");
	}
	else
	{
		...
		{
			strcpy(szOn, "");
			strcpy(szOff,"");
		}
